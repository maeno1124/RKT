...
module.exports = {
  ...
  createStudyTable: `
    CREATE TABLE IF NOT EXISTS study (
      studentId         TEXT,
      studyProblemId    INTEGER,
      answer            TEXT,
      correction        TEXT,
      PRIMARY KEY (studentId, studyProblemId),
      FOREIGN KEY (studentId) REFERENCES students (studentId),
      FOREIGN KEY (studyProblemId) REFERENCES CramSchoolMaterials (studyProblemId)
    );
  `,
  ...
  createIndividualLearningTable: `
    CREATE TABLE IF NOT EXISTS individual_learning (
      ...
      FOREIGN KEY (studentId) REFERENCES students (studentId),
      FOREIGN KEY (aiProblemId) REFERENCES AIProblem (aiProblemId)
    );
  `,
  ...
  createTeachingMaterialsTable: `
    CREATE TABLE IF NOT EXISTS teachingMaterials (
      teachingMaterialsId INTEGER PRIMARY KEY,
      problemStatement TEXT,
      OptionA TEXT,
      OptionB TEXT,
      OptionC TEXT,
  ...
  createAIProblemTable: `
    CREATE TABLE IF NOT EXISTS AIProblem (
      aiProblemId INTEGER PRIMARY KEY,
      problemStatement TEXT,
      OptionA TEXT,
      OptionB TEXT,
      OptionC TEXT,
   ...
   */
  insertSelfLearningRecord: `INSERT INTO self_learning (studentId, teachingMaterialsId, answer, correction) VALUES (?, ?, ?, ?);`,
   ...
   */
  insertStudyRecord: `INSERT INTO study (studentId, studyProblemId, answer, correction) VALUES (?, ?, ?, ?);`,

  /**
   * individual_learningテーブルに新しい個別学習記録を挿入します。
   * studentId, aiProblemId, answer, correction をパラメータとして受け取ります。
   */
  insertIndividualLearningRecord: `INSERT INTO individual_learning (studentId, aiProblemId, answer, correction) VALUES (?, ?, ?, ?);`,
